...
task augmentation on a client that negotiates it. For Seedance, Seed 3D, and MediaKit
...
The presigned URL is valid for 30 minutes by default (configurable via

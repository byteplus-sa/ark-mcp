...
| `prompt_optimization` | "standard" \| "fast" | No | Prompt optimization mode; defaults to standard on 5.0 Pro |
| `persist` | boolean | No | Whether to persist output (default: true) |
...
| `response_format` | "url" \| "b64_json" | No | — | Response format |
| `watermark` | boolean | No | — | AIGC watermark |
| `prompt_optimization` | "standard" \| "fast" | No | standard on 5.0 Pro | Optimization mode |
